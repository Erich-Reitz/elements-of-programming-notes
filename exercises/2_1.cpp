// Exercise: Implement a definition-space predicate for addition on 32 bit signed integers
...
struct OutOfDefinitionSpace : public std::runtime_error {
    OutOfDefinitionSpace(const std::string& what = "") : std::runtime_error(what) {}
} ; 
